      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="mb-10 text-center">
          ...
          <p className="mt-3 max-w-2xl mx-auto text-xl text-gray-500 sm:mt-4">
            Manage and update all property listings
          </p>
        </div>
                ...
                <div className="flex flex-col sm:flex-row">
                  <div className="flex-1">
                    <div className="flex items-center">
                      ...
                      <span className={`ml-3 inline-flex items-center px-3 py-0.5 rounded-full text-sm font-medium ${
...
<div className="flex items-start mt-4">
  <svg className="flex-shrink-0 h-5 w-5 text-gray-400" fill="none" stroke="currentColor" strokeWidth="1.5"
       viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    <path strokeLinecap="round" strokeLinejoin="round"
          d="M5.121 17.804A8.25 8.25 0 0112 3.75a8.25 8.25 0 016.879 14.054M15 12.75l-3 3-3-3"/>
  </svg>
  <div className="ml-3">
    <p className="text-sm text-gray-500">Posted By</p>
    <p className="text-sm font-medium text-gray-900">{property.userName}</p>
    <p className="text-sm text-gray-500">📧 {property.userEmail}</p>
    <p className="text-sm text-gray-500">📞 {property.userMobile}</p>
  </div>
</div>
...
<div className="flex items-start">
  <svg className="flex-shrink-0 h-5 w-5 text-gray-400" fill="none" stroke="currentColor" strokeWidth="1.5"
       viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    <path strokeLinecap="round" strokeLinejoin="round"
          d="M12 2.25c4.5 1.5 9 2.25 9 5.25v4.5c0 5.25-3.75 9-9 10.5-5.25-1.5-9-5.25-9-10.5V7.5c0-3 4.5-3.75 9-5.25z"/>
  </svg>
  <div className="ml-3">
    <p className="text-sm text-gray-500">Security</p>
    <p className="text-sm font-medium text-gray-900">{property.security ? "Available" : "Not Available"}</p>
  </div>
</div>
...
<div className="flex items-start mt-2">
  ...
  <div className="ml-3">
    ...
    <p className="text-sm font-medium text-gray-900">{property.powerBackup ? "Available" : "Not Available"}</p>
  </div>
</div>
...
<div className="flex items-start mt-2">
  <svg className="flex-shrink-0 h-5 w-5 text-gray-400" fill="none" stroke="currentColor" strokeWidth="1.5"
       viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    <path strokeLinecap="round" strokeLinejoin="round"
          d="M12 3c2.5 3.5 5 7 5 9.5a5 5 0 01-10 0C7 10 9.5 6.5 12 3z"/>
  </svg>
  <div className="ml-3">
    <p className="text-sm text-gray-500">Water Supply</p>
    <p className="text-sm font-medium text-gray-900">{property.waterSupply ? "Available" : "Not Available"}</p>
  </div>
</div>
...
<div className="flex items-start mt-2">
  <svg className="flex-shrink-0 h-5 w-5 text-gray-400" fill="none" stroke="currentColor" strokeWidth="1.5"
       viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    <path strokeLinecap="round" strokeLinejoin="round"
          d="M3 12h18M4 8h16M4 16h16M8 20v-4M16 20v-4"/>
  </svg>
  <div className="ml-3">
    <p className="text-sm text-gray-500">Air Conditioning</p>
    <p className="text-sm font-medium text-gray-900">{property.ac ? "Available" : "Not Available"}</p>
  </div>
</div>
...
<div className="flex items-start mt-2">
  <svg className="flex-shrink-0 h-5 w-5 text-gray-400" fill="none" stroke="currentColor" strokeWidth="1.5"
       viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    <path strokeLinecap="round" strokeLinejoin="round"
          d="M2.25 8.25a15.75 15.75 0 0119.5 0M5.5 11.5a11.25 11.25 0 0113 0M8.75 14.75a6.75 6.75 0 016.5 0M12 18.75h.008v.008H12v-.008z"/>
  </svg>
  <div className="ml-3">
    <p className="text-sm text-gray-500">WiFi</p>
    <p className="text-sm font-medium text-gray-900">{property.wifi ? "Available" : "Not Available"}</p>
  </div>
</div>
